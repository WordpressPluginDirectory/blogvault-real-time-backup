...
if (!class_exists('BVProtectWPUser_V647')) :
class BVProtectWPUser_V647 {
	public $id;
	public $role;
	public $role_level;
	public $capabilities;
	...
	public static function defaultUser() {
		...
		return (new BVProtectWPUser_V647(0, 0, array(), $time));
	}
	...
	public static function _unserialize($serialized_user) {
		...
		return (new BVProtectWPUser_V647((int) $id, (int) $role_level, $capabilities, (int) $time));
	}
