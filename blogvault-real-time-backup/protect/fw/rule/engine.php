...
if (!class_exists('BVProtectFWRuleEngine_V585')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V585 {
	use BVProtectFWRuleStringFunc_V585;
	use BVProtectFWRuleArrayFunc_V585;
	use BVProtectFWRuleMiscFunc_V585;
	use BVProtectFWRuleRequestFunc_V585;
	use BVProtectFWRuleWPFunc_V585;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V585::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V585 $e) {
			$this->error = $e;
		}
	}
