...
if (!class_exists('BVProtectFWRuleEngine_V647')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V647 {
	use BVProtectFWRuleStringFunc_V647;
	use BVProtectFWRuleArrayFunc_V647;
	use BVProtectFWRuleMiscFunc_V647;
	use BVProtectFWRuleRequestFunc_V647;
	use BVProtectFWRuleWPFunc_V647;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V647::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V647 $e) {
			$this->error = $e;
		}
	}
