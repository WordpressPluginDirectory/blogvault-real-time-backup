...
if (!class_exists('BVProtectFWRuleEngine_V577')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V577 {
	use BVProtectFWRuleStringFunc_V577;
	use BVProtectFWRuleArrayFunc_V577;
	use BVProtectFWRuleMiscFunc_V577;
	use BVProtectFWRuleRequestFunc_V577;
	use BVProtectFWRuleWPFunc_V577;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V577::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V577 $e) {
			$this->error = $e;
		}
	}
