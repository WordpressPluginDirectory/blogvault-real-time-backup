...
if (!class_exists('BVProtectFWRuleEngine_V639')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V639 {
	use BVProtectFWRuleStringFunc_V639;
	use BVProtectFWRuleArrayFunc_V639;
	use BVProtectFWRuleMiscFunc_V639;
	use BVProtectFWRuleRequestFunc_V639;
	use BVProtectFWRuleWPFunc_V639;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V639::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V639 $e) {
			$this->error = $e;
		}
	}
